...
def resnext(width, height, frame_count, lr, output=5, model_name = 'sentnet_color.model'):
...
def sentnet_color_2d(width, height, frame_count, lr, output=5, model_name = 'sentnet_color.model'):
...
def sentnet_color(width, height, frame_count, lr, output=5, model_name = 'sentnet_color.model'):
    network = input_data(shape=[None, width, height,3, 1], name='input')
...
def alexnet2(width, height, lr, output=5):
